...
Appearance.create(guest: Guest.first, episode: Episode.first)
Appearance.create(guest: Guest.second, episode: Episode.second)
Appearance.create(guest: Guest.third, episode: Episode.third)