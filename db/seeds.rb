...
ap_1 = Appearance.create(rating:10, episode_id:Episode.all.first, guest_id: Guest.all.first)
ap_2 = Appearance.create(rating:10, episode_id:Episode.all.first, guest_id: Guest.all.last)